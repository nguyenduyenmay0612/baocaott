          ...
          <div class="row align-items-center">
           <!--  <div class="col-md-5 col-xl-6 col-xxl-7 order-0 order-md-1 text-end"><img class="pt-7 pt-md-0 w-100" src="assets/img/illustrations/hero.png" alt="hero-header" /></div> -->
            <div class="col-md-75 col-xl-6 col-xxl-5 text-md-start text-center py-8">
              ...
              <h1 class="fw-bolder fs-6 fs-xxl-7 mb-2">Bán, lắp đặt camera, sữa chữa tivi. <br> Đào tạo dạy nghề</h1>
              <p class="fs-1 mb-5">Tạo niềm tin<br />uy tín, chất lượng. </p><a style="width: 300px; height: 70px; font-size: 40px;" class="btn btn-primary me-2" href="https://www.facebook.com/laptopcutaiquangtri" role="button">FACE BOOK <i class="fas fa-arrow-right ms-2"></i></a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          ...
          <div class="row h-100 justify-content-center">
            <div class="col-md-4 pt-4 px-md-2 px-lg-3">
              <div class="card h-100 px-lg-5 card-span">
                <div class="card-body d-flex flex-column justify-content-around">
                  <div class="text-center pt-5"><img class="img-fluid" src="{{('public/frontend/img/lap1.jpg')}}" alt="..." />
                    <h5 class="my-4">Laptop</h5>
                  </div>
                  <p>Bán lap top mới và cũ, sữa chữa, phụ tùng laptop</p>
                <!--   <ul class="list-unstyled">
                  ...
                  <div class="text-center my-5">
                    <div class="d-grid">
                    <a href="{{URL::to('/laptop')}}"> <button class="btn btn-outline-danger" type="submit">Learn more </button> </a> 
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-4 pt-4 px-md-2 px-lg-3">
              <div class="card h-100 px-lg-5 card-span">
                <div class="card-body d-flex flex-column justify-content-around">
                  <div class="text-center pt-5"><img class="img-fluid" src="{{('public/frontend/img/ssd.jpg')}}" alt="..." /> <br>   <h5 class="my-4">Thiết bị</h5>
                  </div> 
                  <p>Thiết bị phần cứng máy tính mới và cũ</p>
               
                  <div class="text-center my-5">
                    <div class="d-grid">
                     <a href="{{URL::to('/thietbi')}}"> <button class="btn btn-danger hover-top btn-glow border-0" type="submit">Learn more</button> </a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-4 pt-4 px-md-2 px-lg-3">
              <div class="card h-100 px-lg-5 card-span">
                <div class="card-body d-flex flex-column justify-content-around">
                  <div class="text-center pt-5"><img class="img-fluid" src="{{('public/frontend/img/cam.jpg')}}" alt="..." /> <br> <br>
                    <h5 class="my-4">Camera</h5>
                  </div>
                  <p>Lắp đặt camera uy tín, chất lượng, bảo hành tốt.</p>
             
                  <div class="text-center my-5">
                    <div class="d-grid">
                    <a href="{{URL::to('/camera')}}"> <button class="btn btn-outline-danger" type="submit">Learn more </button> </a> 
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section class="pt-7 pb-0">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-6 col-lg mb-5">
              <div class="text-center"><img src="{{('public/frontend/img/goods.png')}}" alt="..." />
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-6 col-lg-5 col-xl-4"><img src="{{('public/frontend/img/callback.png')}}" alt="..." />
              <h5 class="text-danger">Bạn có thắc mắc gì</h5>
              <h2>Hãy gửi câu hỏi Chúng tôi sẽ chủ động liên hệ bạn</h2>
              <p class="text-muted">Monday to Friday, 9am-5pm.</p>
            </div>
            <div class="col-md-6 col-lg-5 col-xl-4">
              <form class="row" action="{{URL::to('/save-cauhoi')}}" method="post">
                 {{ csrf_field() }}
                <div class="mb-3">
                  <label class="form-label visually-hidden" for="inputName">Tên khách hàng</label>
                  <input class="form-control form-quriar-control" name="name" type="text" placeholder="Tên" />
                </div>
                <div class="mb-3">
                  <label class="form-label visually-hidden" for="inputEmail"></label>
                  <input class="form-control form-quriar-control" name="phone" type="text" placeholder="Số điện thoại " />
                </div>
                <div class="mb-5">
                  <label class="form-label visually-hidden"  for="validationTextarea">Message</label>
                  <textarea class="form-control form-quriar-control is-invalid border-400" name="cauhoi" id="validationTextarea" placeholder="Bạn muốn hỏi gì vậy? Hãy cho chúng tôi biết!" style="height: 150px" required="required"></textarea>
                </div>
                <div class="d-grid">
                  <button onclick="alert('Gửi câu hỏi thành công. Chúng tôi sẽ liên hệ với bạn.')" class="btn btn-primary" type="submit">Gửi tin nhắn<i class="fas fa-paper-plane ms-2"></i></button>
                </div>
              </form>
            </div>
          </div>
