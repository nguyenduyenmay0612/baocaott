      ...
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block bg-light shadow-transition" data-navbar-on-scroll="data-navbar-on-scroll" background-color:="" rgba(249,="" 250,="" 253,="" 0);="" style="background-image: none; transition: none 0s ease 0s;">
        <div class="container"><a class="navbar-brand" href="{{URL::to('/trang-chu')}}"><img src="{{('public/frontend/img/lv.png')}}" height="60" alt="logo"></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            ...
            <form class="d-flex my-3 d-block d-lg-none" action="{{URL::to('/timkiem-thietbi')}}" method="get">
    ...
    <section class="py-7" id="services" container-xl="container-xl">
      ...
      <div class="container">
        ...
        <div class="row h-100 justify-content-center">
          @foreach($timkiem_thietbi as $key1=>$thietbi)
          <div class="col-md-4 pt-4 px-md-2 px-lg-3">
            <div class="card h-100 px-lg-5 card-span">
              <div class="card-body d-flex flex-column justify-content-around">
                <div class="text-center pt-5"><img height="250" width="250" src="{{URL::to('public/upload/sanpham/'.$thietbi->anh_thietbi)}}" alt="..." />
                 <b> <h5 class="my-4">Tên :{{ $thietbi->ten_thietbi}}</h5></b>
                </div>

                <ul class="list-unstyled">
                  <li class="mb-2"><span class="me-2"><i class="fas fa-circle text-primary" style="font-size:.5rem"></i></span>{{ $thietbi->mota_thietbi}}
                  </li>
                    ...
                    <li><p><b>Giá : {{ $thietbi->gia_thietbi}} </b> </p></li>
                  </ul>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form  action="{{URL::to('/save-donhang')}}" method="post">
                      ...
                      <div class="form-group">
                        <label class="col-sm-3 control-label col-lg-3" for="inputSuccess">Tên thietbi</label>
                        <div class="col-lg-12">
                          <select class="form-control m-bot15" name="name_sp">
                           
                          @foreach($timkiem_thietbi as $key=>$thietbi)
                           <option>{{ $thietbi->ten_thietbi}}.  <b> Giá:{{ $thietbi->gia_thietbi}}</b> </option>
                           @endforeach
                          </select>
                        </div>
                      </div>
