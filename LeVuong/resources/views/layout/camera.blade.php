          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            ...
            <div class="dropdown d-none d-lg-block">
              ...
              <div class="dropdown-menu dropdown-menu-lg-end p-0 rounded" aria-labelledby="dropdownMenuButton1" style="top:55px">
                <form action="{{URL::to('/timkiem-camera')}}" method="get">
                  <input class="form-control border-200" type="search" name="key2" placeholder="Search" aria-label="Search" style="background:#CCCCCC;">
                </form>
              </div>
            </div><a class="btn btn-primary order-1 order-lg-0 ms-lg-3"href="{{URL::to('/lienhe')}}">Đăng kí học viên</a>
            <form class="d-flex my-3 d-block d-lg-none" action="{{URL::to('/timkiem-camera')}}" method="get">
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-8 col-lg-5 text-center mb-3">
              <h5 class="text-danger">Camare</h5>
              <h2>NHỮNG CAMERA CÓ TẠI CỬA HÀNG</h2>
            </div>
            ...
            <div class="col-md-4 pt-4 px-md-2 px-lg-3">
              <div class="card h-100 px-lg-5 card-span">
                <div class="card-body d-flex flex-column justify-content-around">
                  <div class="text-center pt-5"><img height="250" width="250" src="{{URL::to('public/upload/sanpham/'.$camera->anh_camera)}}" alt="..." />
                    <h5 class="my-4">{{ $camera->ten_camera}} </h5>
                  </div>
                  
                  <ul class="list-unstyled">
                    <li class="mb-2"><span class="me-2"><i class="fas fa-circle text-primary" style="font-size:.5rem"></i></span>{{ $camera->mota_camera}}
                    </li>
                    <li><p><b>Giá : {{ $camera->gia_camera}} </b> </p></li>
                  </ul>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-12">
                          ...
                          <option >Bàn Phím Laptop Dell Inspiron 3501</option> -->
                           @foreach($all_camera as $key=>$camera)
                           <option>{{ $camera->ten_camera}}. Giá :{{ $camera->gia_camera}} </option>
                           @endforeach
                          </select>
                        </div>
                      </div>
