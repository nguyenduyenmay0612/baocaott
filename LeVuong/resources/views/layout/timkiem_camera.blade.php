    ...
    <section class="py-7" id="services" container-xl="container-xl">
      ...
      <div class="container">
        ...
        <div class="row h-100 justify-content-center">
          @foreach($timkiem_camera as $key=>$camera)
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form  action="{{URL::to('/save-donhang')}}" method="post">
                      ...
                      <div class="form-group">
                        <label class="col-sm-3 control-label col-lg-3" for="inputSuccess">Tên camera</label>
                        <div class="col-lg-12">
                          <select class="form-control m-bot15" name="name_sp">
                           
                          @foreach($timkiem_camera as $key=>$camera)
                           <option>{{ $camera->ten_camera}}.  <b> Giá:{{ $camera->gia_camera}}</b> </option>
                           @endforeach
                          </select>
                        </div>
                      </div>
