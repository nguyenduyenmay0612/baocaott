          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            ...
            <div class="dropdown d-none d-lg-block">
              ...
              <div class="dropdown-menu dropdown-menu-lg-end p-0 rounded" aria-labelledby="dropdownMenuButton1" style="top:55px">
                <form action="{{URL::to('/timkiem-thietbi')}}" method="get">
                  <input class="form-control border-200" type="search" name="key1" placeholder="Search" aria-label="Search" style="background:#CCCCCC;">
                </form>
              </div>
            </div><a class="btn btn-primary order-1 order-lg-0 ms-lg-3"href="{{URL::to('/lienhe')}}">Đăng kí học viên</a>
            <form class="d-flex my-3 d-block d-lg-none" {{URL::to('/timkiem-thietbi')}}" method="get">
          ...
          <div class="row align-items-center">
           <!--  <div class="col-md-5 col-xl-6 col-xxl-7 order-0 order-md-1 text-end"><img class="pt-7 pt-md-0 w-100" src="assets/img/illustrations/hero.png" alt="hero-header" /></div> -->
            <div class="col-md-75 col-xl-6 col-xxl-5 text-md-start text-center py-8">
              <h1 class="fw-normal fs-6 fs-xxl-7">Mua bán, sữa chữa thietbi cũ </h1>
              <h1 class="fw-bolder fs-6 fs-xxl-7 mb-2">Lắp đặt camera, sữa chữa tivi. <br> Đào tạo dạy nghề</h1>
              <p class="fs-1 mb-5">Tạo niềm tin<br />uy tín, chất lượng. </p><a class="btn btn-primary me-2" href="https://www.facebook.com/thietbicutaiquangtri" role="button">FACE BOOK <i class="fas fa-arrow-right ms-2"></i></a>
            </div>
          </div>
        </div>
      </section>
         <section id="findUs" style="margin-top: -50px;">

        <div class="container">
           
          <div class="row justify-content-center">
            <div class="col-md-8 col-lg-5 mb-6 text-center">
              <h3 class="text-danger">THIẾT BỊ</h3>
            ...
            <div class="col-12">
              <div class="card card-span rounded-2 mb-3">
                <div class="row">
                  <div class="col-md-8 col-lg-6 d-flex"><img style="width: 200; height: 200px; margin-left: 50px;margin-top: 50px;" src="{{URL::to('public/upload/sanpham/'.$thietbi->anh_thietbi)}}" alt="map" /> <br>                
                  </div>
                  <div class="col-md-3 col-lg-5 d-flex flex-center">
                    <div class="card-body">
                      <h5>Thông tin</h5>
                      <p class="text-600 my-3"><b> <span>{{ $thietbi->ten_thietbi}} </span></b></p>
                      <p><span class="text-600">{{ $thietbi->mota_thietbi}}<br/><span class="ps-4"></span></p>
                      <p><b>Giá : {{ $thietbi->gia_thietbi}}</b></p>
                       <div class="text-center my-4">
                    <div class="d-grid">
                      <button class="btn btn-outline-danger" type="submit" data-toggle="modal" data-target="#myModal1">Đặt hàng ngay</button>
                    </div>
                  </div>
                    </div>
                  </div>
                    ...
                    <form  action="{{URL::to('/save-donhang')}}" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-12">
                          ...
                          <!-- <option >RAM Kingston 8GB 2400 DDR4 CL15 DIMM</option>
                          <option >Ổ cứng HDD Seagate Barracuda 1TB 3.5</option>
                          <option >Bàn Phím Laptop Dell Inspiron 3501</option> -->
                           @foreach($all_thietbi as $key=>$thietbi)
                           <option>{{ $thietbi->ten_thietbi}}. Giá: {{ $thietbi->gia_thietbi}}</option>
                           @endforeach
                          </select>
                        </div>
                      </div>
