        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/all-donhang')}}">Đơn đặt hàng</a></li>
                        <li><a href="{{URL::to('/all-cauhoi')}}">Câu hỏi từ khách hàng</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/add-laptop')}}">Thêm laptop</a></li>
                        <li><a href="{{URL::to('/all-laptop')}}">Bảng liệt kê laptop</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/add-thietbi')}}">Thêm thiết bị</a></li>
                        <li><a href="{{URL::to('/all-thietbi')}}">Tất cả thiết bị</a></li>
                    </ul>
                </li>  
                 <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/add-camera')}}">Thêm camera</a></li>
                        <li><a href="{{URL::to('/all-camera')}}">Tất cả camera</a></li>
                    </ul>
                </li>                             
                <li>
                    <a onclick="return confirm('Bạn có muốn đăng xuất không?')" href="{{URL::to('/login-admin')}}">
 ...
 <!-- footer -->
          <div class="footer"style="background-color:#AAAAAA	  ;">
            <div class="wthree-copyright">
              <p>© 2021 Tin học Lê Vương| Design by <a href="http://w3layouts.com">Duyên Mây</a></p>
            </div>
          </div>
  <!-- / footer -->
</section>
